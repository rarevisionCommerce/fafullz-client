...
function GoogleVoiceOrders(props) {
  ...
  const downloadOrders = (orders) => {
    ...
    const orderText = 'Google Voice orders\n\n'+ orders
      ?.map((order, index) => {
    ...
    link.download = `Google Voice orders.txt`;
    ...
    <div>
      <div className="mb-[30px]">
        ...
        <div className="overflow-x-auto mb-3">
          ...
          <div>
            <h1 className="text-sm text-center my-2">{!props?.gVoice?.length && 'No Orders!' }</h1>
          </div>
            ...
            <div  className="overflow-x-auto mb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  onClick={()=>{
                    downloadOrders(todaysOrders, 'Google voice') 
                  }}
                  >
                    Download
                  </button>
                      ...
                      >
                        ...
                        <td className="border-collapse border-b border-slate-500 py-3 px-3">
                          ...
                          getHourDifference(item?.purchaseDate) > 24 ? (
                            ...
                            <Link
                              to={`/dash/refund-request/gVoice/${item?._id}`}
            ...
            <div  className="overflow-x-auto mb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <button className="text-xs bg-gray-200 px-2 py-1 rounded-md  "
                   onClick={()=>{
                    downloadOrders(yesterdaysOrders, 'Google voice') 
                  }}
                  >
                    Download
                  </button>
            ...
            <div  className="overflow-x-auto mb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <button className="text-xs bg-gray-200 px-2 py-1 rounded-md  "
                   onClick={()=>{
                    downloadOrders(earlierOrders, 'Google voice') 
                  }}
                  >
                    Download 
                  </button>
...
export default GoogleVoiceOrders;
