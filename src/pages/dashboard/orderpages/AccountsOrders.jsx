    ...
    <div>
      <div className="mb-[30px]">
        <div className="overflow-x-auto mb-3 rounded-md border border-slate-500">
          <table className="w-full text-center table-auto border-collapse  text-light text-sm">
            ...
            <tbody className="text-dark">
              {!props?.account || props?.account?.length < 1 ? (
                <tr>
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="border-collapse border-b border-slate-500 py-3 px-3">
                        <a
                          href={`${item?.filePath}`}
                          onClick={(e) =>{ e.preventDefault(); handleDownload(item?.filePath)}}
                          download
