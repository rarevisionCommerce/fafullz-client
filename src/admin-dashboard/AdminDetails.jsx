...
function AdminDetails() {
  ...
  const sellerEarning = 1 * totalPrice;
  const pullzEarning = 0 * totalPrice;
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-200">
      <div className=" px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400 mt-1">
            Manage admin information and products
          </p>
        </div>
              ...
              <div className="space-y-4">
                ...
                {loadingActivating || loadingDeactivate || loadingSuspend ? (
                  ...
                  <div className="space-y-2">
                    {sellerData?.data?.status === "Active" ? (
                      <Button color="red" fullWidth onClick={openDeactivate}>
                        Deactivate
                      </Button>
                    ) : (
                      <Button onClick={openActivate} color="green" fullWidth>
                        Activate
                      </Button>
                    )}

                    {sellerData?.data?.status !== "Suspended" && (
                      <Button color="yellow" fullWidth onClick={openSuspend}>
                        Suspend
                      </Button>
                    )}
                  </div>
      ...
      >
        ...
        <Group position="right" mt="md">
          <Button variant="default" onClick={closeActivate}>
            Cancel
          </Button>
      ...
      >
        ...
        <Group position="right" mt="md">
          ...
          <Button color="yellow" onClick={handleSuspend}>
            Suspend
          </Button>
        </Group>
      </Modal>
      ...
      >
        ...
        <Group position="right" mt="md">
          <Button variant="default" onClick={closePayAll}>
            Cancel
          </Button>
