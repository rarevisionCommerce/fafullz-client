    ...
    <div className="bg-[#0b1220] py-5 px-5 min-h-screen text-gray-200">
      ...
      >
        ...
        <div className="bg-[#1f2937] border border-yellow-600/40 px-2 py-3 rounded mt-3">
          ...
          <p className="flex flex-wrap w-full mb-2 text-gray-100">
            firstName, lastName, country, state, zip, dob, address, ssn, cs, city, description, enrollment, enrollmentDetails, twoFa, level, programs, email, emailPass, faUname, faPass, backupCode, securityQa
          </p>
