...
function GoogleVoiceProducts(props) {
  ...
  } = useQuery([`gVoices-${auth?.jabberId}`, activePage], fetchProducts, {
      ...
      customUI: ({ onClose }) => {
        return (
          <div className=" shadow-xl p-[30px] flex flex-col gap-4">
            <h1 className="font-bold text-xl">Delete Google Voice!</h1>
        ...
        <div className="overflow-x-auto mb-3">
          ...
          <table className="w-full text-center table-auto border-collapse border border-slate-500 text-light text-sm">
            ...
            <tbody className="text-dark">
              {!productData?.data?.gVoices ||
              productData?.data?.gVoices?.length < 1 ? (
                <tr>
