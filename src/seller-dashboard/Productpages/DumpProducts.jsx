...
function DumpProducts() {
  ...
  } = useQuery([`dumps-${auth?.jabberId}`, activePage], fetchProducts, {
      ...
      customUI: ({ onClose }) => {
        return (
          <div className=" shadow-xl p-[30px] flex flex-col gap-4">
            <h1 className="font-bold text-xl">Delete Dump!</h1>
          ...
          <table className="w-full text-center table-auto border-collapse border border-slate-500 text-light text-sm">
            ...
            <tbody className="text-dark">
              ...
              productData?.data?.files?.length < 1 ? (
                <tr>
                  <td colSpan={11} className="text-gray-800 text-center py-3">
                    No Dump products
                  </td>
                </tr>
