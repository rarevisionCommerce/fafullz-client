...
function TextNowProducts(props) {
  ...
  } = useQuery([`mails-${auth?.jabberId}`, activePage, perPage, status, isPaid], fetchProducts, {
  ...
  return (
    <div className="min-h-screen">
         ...
         <div className="overflow-x-auto">
             <Table striped highlightOnHover withBorder withColumnBorders style={{ color: '#d1d5db' }}>
                ...
                <tbody>
                    ...
                    ) : !productData?.data?.mails || productData?.data?.mails?.length < 1 ? (
                        <tr>
      ...
      <Modal 
        opened={deleteOpened} 
        onClose={closeDelete} 
        title={<Text color="white">Delete TextNow/Mail Product</Text>} 
        centered
        styles={{ 
